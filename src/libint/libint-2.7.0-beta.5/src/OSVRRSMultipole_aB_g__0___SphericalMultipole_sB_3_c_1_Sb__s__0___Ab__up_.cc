...
fp54 = fp64 + src5[((hsi*10+2)*1+lsi)*1];
...
fp58 = 0.0000000000000000e+00 + src5[((hsi*10+1)*1+lsi)*1];
...
fp63 = 5.0000000000000000e-01 * src4[((hsi*10+1)*1+lsi)*1];
...
fp69 = 0.0000000000000000e+00 + src5[((hsi*10+0)*1+lsi)*1];
...
fp74 = 5.0000000000000000e-01 * src4[((hsi*10+0)*1+lsi)*1];
