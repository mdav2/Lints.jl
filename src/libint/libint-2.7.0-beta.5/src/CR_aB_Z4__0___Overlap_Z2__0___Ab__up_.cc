...
fp43 = inteval->PA_z[vi] * target[((hsi*15+1)*1+lsi)*1];
...
fp37 = inteval->PA_z[vi] * target[((hsi*15+3)*1+lsi)*1];
...
fp22 = inteval->PA_z[vi] * target[((hsi*15+7)*1+lsi)*1];
...
fp25 = inteval->PA_z[vi] * target[((hsi*15+6)*1+lsi)*1];
LIBINT2_REALTYPE fp23;
fp23 = fp25 + fp24;
target[((hsi*15+9)*1+lsi)*1] = fp23;
LIBINT2_REALTYPE fp47;
fp47 = inteval->PB_z[vi] * target[((hsi*15+1)*1+lsi)*1];
...
fp41 = inteval->PA_z[vi] * target[((hsi*15+2)*1+lsi)*1];
LIBINT2_REALTYPE fp38;
fp38 = fp41 + fp39;
target[((hsi*15+5)*1+lsi)*1] = fp38;
LIBINT2_REALTYPE fp30;
fp30 = inteval->PA_z[vi] * target[((hsi*15+5)*1+lsi)*1];
...
fp18 = inteval->PA_z[vi] * target[((hsi*15+8)*1+lsi)*1];
...
fp4 = inteval->PA_z[vi] * target[((hsi*15+11)*1+lsi)*1];
...
fp9 = inteval->PA_z[vi] * target[((hsi*15+10)*1+lsi)*1];
...
fp13 = inteval->PA_z[vi] * target[((hsi*15+9)*1+lsi)*1];
