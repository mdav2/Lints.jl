...
fp29 = inteval->PA_y[vi] * src0[((hsi*10+6)*1+lsi)*1];
...
fp41 = inteval->PA_z[vi] * src0[((hsi*10+4)*1+lsi)*1];
...
fp45 = inteval->PA_z[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp53 = inteval->PA_y[vi] * src0[((hsi*10+3)*1+lsi)*1];
...
fp69 = inteval->PA_y[vi] * src0[((hsi*10+1)*1+lsi)*1];
...
fp88 = inteval->PA_x[vi] * src0[((hsi*10+0)*1+lsi)*1];
